...
public static void testcase7() throws RowsExceededException, WriteException, IOException, BiffException{
	...
	WM.setValueById("cpn1","Testcamp8");
	...
	WM.ClickLinkByText("Testcamp8");
	WM.ClickLinkBynameExpHandle("del");
	WM.alertAccept();
	WM.logout();	
}
